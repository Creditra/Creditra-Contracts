...
mod tests {
    ...
    use crate::events::{
        publish_credit_line_event_v2, publish_repayment_event_v2, publish_drawn_event_v2,
        publish_interest_accrued_event, publish_rate_formula_config_event,
        publish_admin_rotation_proposed, publish_admin_rotation_accepted,
        publish_borrower_blocked_event, CreditLineEventV2, RepaymentEventV2,
        DrawnEventV2, InterestAccruedEvent, RateFormulaConfigEvent,
        AdminRotationProposedEvent, AdminRotationAcceptedEvent, BorrowerBlockedEvent,
    };
    use crate::storage::is_borrower_blocked;
    use crate::Credit;
    use crate::CreditClient;
    use soroban_sdk::{testutils::{Address as _, Ledger}, Address, Env, symbol_short};
    ...
    fn test_event_publishers() {
        ...
        publish_credit_line_event_v2(&env, (symbol_short!("c"), symbol_short!("o")), CreditLineEventV2 {
        ...
        publish_rate_formula_config_event(&env, RateFormulaConfigEvent {
            base_rate_bps: 100,
            slope_bps_per_score: 10,
            min_rate_bps: 100,
            max_rate_bps: 1000,
        ...
        publish_admin_rotation_proposed(&env, AdminRotationProposedEvent {
            current_admin: admin.clone(),
            proposed_admin: borrower.clone(),
            accept_after: 100,
        });
        
        publish_admin_rotation_accepted(&env, AdminRotationAcceptedEvent {
